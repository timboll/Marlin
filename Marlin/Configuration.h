...
#define STRING_CONFIG_H_AUTHOR "(BIGTREETECH, Octopus-Pro-E5P)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "OP-E5P"
...
#define PIDTEMPBED
  ...
  // from FOPDT model - kp=.39 p=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  #define DEFAULT_bedKp 245.63
  #define DEFAULT_bedKi 29.23
  #define DEFAULT_bedKd 1375.93
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 433.7 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 30, 30 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2, -36, -1.88 }
...
#define X_MIN_POS -9.7
#define Y_MIN_POS -15.9
#define Z_MIN_POS 0
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    // #define ABL_BILINEAR_SUBDIVISION
      ...
      #define BILINEAR_SUBDIVISIONS 0
    #endif
