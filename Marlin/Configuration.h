...
#define STRING_CONFIG_H_AUTHOR "(BIGTREETECH, SKR-mini-MZ)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR-mini-MZ"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 38.07
  #define DEFAULT_bedKi 1.78
  #define DEFAULT_bedKd 544.15
